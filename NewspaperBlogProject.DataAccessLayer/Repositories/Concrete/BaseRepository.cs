using NewspaperBlogProject.DataAccessLayer.Context;
using NewspaperBlogProject.DataAccessLayer.Repositories.Interface;
...
namespace NewspaperBlogProject.DataAccessLayer.Repositories.Concrete
{
    public class BaseRepository<T> : IBaseRepository<T> where T : BaseEntity
    {
        ...
        public List<T> GetActive() => _context.Set<T>().Where(x => x.Status != Status.Passivied).ToList();
